    ...
    public class Context : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var questions = new List<Question>
            {
                ...
                {
                    Id = 2,
                    QuestionText = "Which of the following is a preposition: on, happy, table, quickly?",
                    Img = "",
                    Points = 15,
                    TestId = 1
                },
            ...
            var answers = new List<Answer>
            {
                new Answer
                {
                    ...
                    AnswerText = "children",
                    IsRight = true,
                    QuestionId = 1 // Відповідь для питання з Id = 1
                },
                new Answer
                {
                    Id = 2,
                    AnswerText = "on",
                    IsRight = true,
                    QuestionId = 2 // Відповідь для питання з Id = 2
                },
                new Answer
                {
                    Id = 3,
            ...
            var userTests = new List<UserTest>
            {
                new UserTest
                {
                    ...
                    IsTaken = true,
                    UserId = 1, // Призначити існуючого користувача
                    TestId = 1, // Призначити існуючий тест
                },
                new UserTest
                {
                    Id = 2,
                    ...
                    TakenDate = DateTime.Now,
                    IsTaken = true,
                    UserId = 2, // Призначити існуючого користувача
                    TestId = 2, // Призначити існуючий тест
                },
                new UserTest
                {
                    Id = 3,
